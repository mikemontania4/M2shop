...
app.use(cors());
//loggerPos();
// Base de datos (comentado para desarrollo sin BD)
// const dbSetup = async () => {
...
// Usar rutas mock para desarrollo sin base de datos
app.use("/M2SHOP", require("./src/routes/mock-routes"));

// Rutas completas (comentadas para desarrollo sin BD)
